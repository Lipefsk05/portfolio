...
'radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(266,100%,90%,var(--card-opacity)) 4%,hsla(266,50%,80%,calc(var(--card-opacity)*0.75)) 10%,hsla(266,25%,70%,calc(var(--card-opacity)*0.5)) 50%,hsla(266,0%,60%,0) 100%),radial-gradient(35% 52% at 55% 20%,#f5f5f5 0%,#cccccc 100%),radial-gradient(100% 100% at 50% 50%,#e0e0e0 1%,#073aff00 76%),conic-gradient(from 124deg at 50% 50%,#ffffff 0%,#dddddd 40%,#bbbbbb 60%,#999999 100%)';
